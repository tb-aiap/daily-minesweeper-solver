...
def test_flag_all_numbers():
    ...
    # second check in board (3, 2)
    result = solver.flag_all_numbers(3, 2, board)
    assert not result

    # third check in board (1, 3)
    result = solver.flag_all_numbers(1, 3, board)
    assert not result
